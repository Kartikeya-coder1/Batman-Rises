...
var batAnimation,bat,batman;


var engine, world;

var rand,cloud,cloud1,cloud2;
var drops = []
var tframe = 0;
...
function setup(){
   ...
   cloud = createSprite(350,20,150,50);
   cloud.addImage(cl)
   cloud1 = createSprite(150,20,150,50);
   cloud1.addImage(cl)
   cloud2 = createSprite(550,20,150,50);
   cloud2.addImage(cl)
//    cloud1
//    clo
...
function draw(){
    ...
    if(frameCount % 200 === 0){
        ...
        // umbrella.velocityY = 2
        umbrella.y = umbrella.y+10;
    }
